...
const Contact = () => {
  const handleSubmit = (event) => {
    ...
    axios
      .post(
        "https://getform.io/f/147ee374-bbc4-4d05-bf6a-ca091fa6aa97",
        formData
      )
      .then((response) => {
        Swal.fire({
      ...
      <div className="flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full">
        ...
        <div className="flex justify-center items-center">
          ...
          >
            ...
            <button className="text-black font-semibold bg-primary-color px-6 py-3 my-8 mx-auto flex items-center rounded-md hover:scale-110 duration-300">
              Let's talk
            </button>
          </form>
        </div>
