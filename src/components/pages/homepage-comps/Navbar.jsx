  ...
  return (
    ...
    >
      <div className="flex flex-row gap-4 items-center text-white">
        <h1 className="text-[1.5rem] lg:text-[1.3rem] text-bold bg-gradient-to-r from-lime-500 to-yellow-400 bg-clip-text text-transparent hover:scale-125 duration-500 cursor-pointer">
          Kuswanth Kumar
        </h1>
      </div>
