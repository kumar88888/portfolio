...
const SocialLinks = () => {
  const links = [
    ...
    },
    {
      ...
      href: "mailto:kuswanthkumarbokam16@gmail.com",
    },
    {
      id: 4,
      child: (
      ...
      <ul>
        {links.map(({ id, child, href, style, download }) => (
          <li
            key={id}
            className={
              "flex justify-between items-center w-40 h-14 px-4 bg-primary-color ml-[-100px] duration-500 hover:rounded-md hover:ml-[-10px]" +
              " " +
              style
            }
          >
